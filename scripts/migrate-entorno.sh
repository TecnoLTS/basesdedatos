...
BACKUP_DIR="/home/admincenter/secure-backups/entorno-migration/paramascotasec-DB/$(date -u +%Y%m%dT%H%M%SZ)"
...
echo "Migracion entorno completada para paramascotasec-DB (${MODE})."
